...
def extract_sdae_childpoet(slope=0.0, dim=10):
    return extractSDAE(dim=[32*32, 500, 500, 2000, dim], slope=slope)


def sdae_childpoet(dropout=0.2, slope=0.0, dim=10):
    return SDAE(dim=[32*32, 500, 500, 2000, dim], dropout=dropout, slope=slope)
######################
