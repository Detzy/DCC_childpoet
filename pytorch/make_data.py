...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', dest='db', type=str, default='easy', help='name of the dataset')
    ...
    if args.db == 'child_poet':
        datadir = r'/uio/hume/student-u31/eirikolb/img/poet_dec2_168h/img_files'
