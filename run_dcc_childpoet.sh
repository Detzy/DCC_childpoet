...
python pytorch/pretraining.py --data child_poet --tensorboard --id 1 --niter 50000 --lr 0.1 --step 20000 --dtype mat
...
python pytorch/DCC.py --data child_poet --net checkpoint_4.pth.tar --tensorboard --id 1 --dtype mat
